        ...
        <div class="hero-body">
            <div class="container has-text-centered">
                <div class="column is-8 is-offset-2">
                    <h3 class="title is-4">Предварительная регистрация</h3>
                    <div class="box">
                        <div class="notification is-small">
                            Коллеги, просьба не регистрироваться повторно, если вы уже были зарегистрированы и забыли пароль! Используйте форму восстановления пароля. На новом аккаунте мебели не будет!
                        </div>
                        ...
                        <form action="/register" accept-charset="UTF-8" method="post">
                            ...
                            <div class="field is-horizontal">
                                ...
                                <div class="field-body">
                                    <div class="field">
                                        <div class="control">
                                            <input class="input" type="text" name="lname" value="{{ old('lname') }}" required="required" placeholder="Введите фамилию">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="field is-horizontal">
                                ...
                                <div class="field-body">
                                    <div class="field">
                                        <div class="control">
                                            <input class="input" type="text" name="fname" value="{{ old('fname') }}" required="required" placeholder="Введите имя">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="control">
                                            <div class="select">
                                                <select name="time_zone">
                                                    ...
                                                    <option value="Central Time (US &amp; Canada)">(GMT-06:00) Central
                                                        Time (US &amp; Canada)
                                                    </option>
                                                    ...
                                                    <option value="Atlantic Time (Canada)">(GMT-04:00) Atlantic Time
                                                        (Canada)
                                                    </option>
                                                    ...
                                                    <option value="West Central Africa">(GMT+01:00) West Central
                                                        Africa
                                                    </option>
                                                    ...
                                                    <option selected="selected" value="Moscow">(GMT+03:00) Moscow
                                                    </option>
                            ...
                            <div class="field is-horizontal">
                                ...
                                <div class="field-body">
                                    <div class="field">
                                        <div class="control">
                                            <input class="input" type="tel" name="phone" required="required" placeholder="+7(999)999-99-99">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <button class="button is-block is-link is-fullwidth has-margin-bottom-20" name="commit">Отправить</button>
