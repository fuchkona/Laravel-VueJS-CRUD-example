...
@section('breadcrumb')
    <ul>
        ...
        <li class="is-active"><a href="#" aria-current="page">Create transition</a></li>
    </ul>
@endsection
            ...
            <div class="column is-10 is-offset-1">
                <div class="field is-horizontal">
                    ...
                    <div class="field-body">
                        <h1 class="title is-4">New transition</h1>
                    </div>
                </div>

                <form action="{{ route('state_machine_module.transitions.store') }}" accept-charset="UTF-8" method="post">
                    @if (count($errors) > 0)
