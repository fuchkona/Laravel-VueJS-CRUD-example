...
@section('breadcrumb')
    <ul>
        ...
        <li class="is-active"><a href="#" aria-current="page">Create demand type</a></li>
    </ul>
@endsection
            ...
            <div class="column is-10 is-offset-1">
                <div class="field is-horizontal">
                    ...
                    <div class="field-body">
                        <h1 class="title is-4">New demand type</h1>
                    </div>
                </div>

                <form action="{{ route('demands_module.demand_types.store') }}" accept-charset="UTF-8" method="post">
                    @if (count($errors) > 0)
